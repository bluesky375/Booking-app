...
@IonicPage()
@Component({
  selector: 'page-edit-pro-contact',
  templateUrl: 'edit-pro-contact.html',
})
export class EditProContactPage extends BasePage{
  ...
  constructor(injector: Injector,
    ...
    this.number = this.user.getUserInfo().number;
  ...
  Submit(){
    ...
    this.user.EditProContacts(d).subscribe(data =>{
      if(data.success){
  ...
  SubmitCode(){
    ...
    this.user.ChangeProNumber(data).subscribe(data => {
      if(data.success){
        this.showContentView();
