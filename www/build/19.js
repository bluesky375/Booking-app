...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_pass__ = __webpack_require__(1076);
...
var EditPassPageModule = /** @class */ (function () {
    ...
    EditPassPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__edit_pass__["a" /* EditPassPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_pass__["a" /* EditPassPage */]),
            ],
        })
    ], EditPassPageModule);
...
//# sourceMappingURL=edit-pass.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditPassPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
...
var EditPassPage = /** @class */ (function (_super) {
    __extends(EditPassPage, _super);
    function EditPassPage(injector, user) {
    ...
    EditPassPage.prototype.ionViewDidLoad = function () {
        this.slides.lockSwipes(true);
        this.firebase_CurrentScreen('Edit User Password Screen');
    };
    EditPassPage.prototype.SubmitForm = function () {
        var _this = this;
        ...
        this.user.editPass(data).subscribe(function (data) {
            if (data.success) {
